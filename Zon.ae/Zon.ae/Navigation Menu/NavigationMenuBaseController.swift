...
class NavigationMenuBaseController: UITabBarController {
    ...
    private func loadTabBar() {
        let tabItems: [TabItem] = [.home, .quotations, .delivery, .profile]
...
//        customTabBar.isUserInteractionEnabled = true
        ...
        let topLine = UIView(frame: CGRect(x: 0, y: 0, width: self.customTabBar.frame.width, height: 2))
        topLine.backgroundColor = UIColor(hexColor: "EDF1F7")
        
        self.customTabBar.addSubview(topLine)
        ...
        NSLayoutConstraint.activate([
            topLine.leadingAnchor.constraint(equalTo: self.customTabBar.leadingAnchor),
            topLine.trailingAnchor.constraint(equalTo: self.customTabBar.trailingAnchor),
            topLine.topAnchor.constraint(equalTo: self.customTabBar.topAnchor),
